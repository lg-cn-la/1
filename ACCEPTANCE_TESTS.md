...
- Public zip must not contain Chinese-named legacy redirect HTML files: `首页.html`, `产品.html`, `解决方案.html`, `资源中心.html`, `资源-跳转页面.html`, `版本方案.html`, or `联系我们.html`.
